...
app.get('/', (req, res) =>{
    ...
    res.send(`
        <ul>
        <li><a href='/product-detail/24680'>product detail</a></li>
        <li><a href='/search/node.js & express.js/5'>Search</a></li>
        <li><a href='/map/10.1122,50.5678/satellite/16'>Views Map</a></li>
        </ul>
        `)
})
